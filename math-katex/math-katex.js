...
window.RevealMath = window.RevealMath || (function() {
	...
	options.katexScript     = options.katexScript     || 'plugin/math-katex/lib/katex-0.9.0/katex.min.js';
	options.katexStylesheet = options.katexStylesheet || 'plugin/math-katex/lib/katex-0.9.0/katex.min.css';
